...
function AddPersonalAndVehicleInfo() {
            ...
            <div>
    {
        ...
        < div className = 'mb-6 flex space-x-20' >
            ...
            {
                aadharImage?
                    <img src = {typeof aadharImage === 'string' ? aadharImage : URL.createObjectURL(aadharImage)
            } className = "max-h-32 w-full object-cover mt-4" />
                                            :
...
onChange = { handleAadharImageChange }
    ...
    {
        licenseImage?
            <img src = {typeof licenseImage === 'string' ? licenseImage : URL.createObjectURL(licenseImage)
    } className = "max-h-32 w-full object-cover mt-4" />
                                            :
<><svg className="w-8 h-12" fill = "currentColor" xmlns = "http://www.w3.org/2000/svg" viewBox = "0 0 20 20" >
    <path d="M16.88 9.1A4 4 0 0 1 16 17H5a5 5 0 0 1-1-9.9V7a3 3 0 0 1 4.52-2.59A4.98 4.98 0 0 1 17 8c0 .38-.04.74-.12 1.1zM11 11h3l-4-4-4 4h3v3h2v-3z" />
...
className = {
    ...
    {
        driverImage?
            <img src = {typeof driverImage === 'string' ? driverImage : URL.createObjectURL(driverImage)
    } className = "max-h-32 w-full object-cover mt-4" />
                                            :
<><svg className="w-8 h-12" fill = "currentColor" xmlns = "http://www.w3.org/2000/svg" viewBox = "0 0 20 20" >
    <path d="M16.88 9.1A4 4 0 0 1 16 17H5a5 5 0 0 1-1-9.9V7a3 3 0 0 1 4.52-2.59A4.98 4.98 0 0 1 17 8c0 .38-.04.74-.12 1.1zM11 11h3l-4-4-4 4h3v3h2v-3z" />
